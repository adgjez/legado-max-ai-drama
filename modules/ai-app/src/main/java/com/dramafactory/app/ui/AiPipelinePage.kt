    ...
    if (vm.finishedEpId != null) {
        Row(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
            ...
            OutlinedButton(onClick = { vm.showStoryboard() }, modifier = Modifier.weight(1f)) {
                Icon(painterResource(R.drawable.ai_ic_movie), contentDescription = null, modifier = Modifier.size(18.dp))
                Spacer(Modifier.width(6.dp)); Text("分镜")
            }
            OutlinedButton(onClick = { vm.showLibrary() }, modifier = Modifier.weight(1f)) {
                Icon(painterResource(R.drawable.ai_ic_video_library), contentDescription = null, modifier = Modifier.size(18.dp))
    ...
    vm.finishedFilmPath?.let { path ->
        Surface(tonalElevation = 2.dp, shape = MaterialTheme.shapes.large,
            ...
            Column(Modifier.padding(12.dp), verticalArrangement = Arrangement.spacedBy(8.dp)) {
                Row(verticalAlignment = Alignment.CenterVertically,
                    horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                    Icon(painterResource(R.drawable.ai_ic_movie), contentDescription = null,
                        tint = MaterialTheme.colorScheme.primary, modifier = Modifier.size(20.dp))
                    ...
                    Button(onClick = {
                        ...
                        ctx?.let {
                            ...
                            val uri = androidx.core.content.FileProvider.getUriForFile(
                                it, "com.dramafactory.app.fileprovider", f)
