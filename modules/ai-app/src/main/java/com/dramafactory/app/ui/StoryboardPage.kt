...
fun StoryboardPage(
    ...
    LazyColumn(
        ...
        if (!st.generating && st.shots.isEmpty()) {
            item {
                EmptyState(
                    icon = { Icon(painterResource(R.drawable.ai_ic_movie), contentDescription = null,
                ...
                Column(Modifier, verticalArrangement = Arrangement.spacedBy(4.dp)) {
                    ...
                    shot.visual_prompt?.let {
                        Row(
                            ...
                            Icon(painterResource(R.drawable.ai_ic_movie), contentDescription = "视觉指令",
                    ...
                    if (refs.isNotEmpty()) {
                        Row(
                            ...
                            Icon(painterResource(R.drawable.ai_ic_link), contentDescription = "引用资产",
                            ...
                            Row(
                                ...
                                if (thumb != null) {
                                    ...
                                    Box(
                                        ...
                                        Icon(painterResource(R.drawable.ai_ic_image), contentDescription = null,
                                            tint = MaterialTheme.colorScheme.onSurfaceVariant,
